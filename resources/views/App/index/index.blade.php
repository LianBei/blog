	...
	<div class="content-wrap">
		<div class="content">
			...
			<article class="excerpt-minic excerpt-minic-index">
				<h2><span class="red">【推荐】</span><a   href="#" title="用DTcms做一个独立博客网站（响应式模板）" >用DTcms做一个独立博客网站（响应式模板）</a>
				</h2>
...
{{--						target="_blank 点击时会打开新页面--}}
					...
					<p class="meta">
						...
						<span class="views"><i class="glyphicon glyphicon-eye-open"></i></span> <a class="comment" href="##comment" title="评论"   ><i class="glyphicon glyphicon-comment"></i> 4</a>
					</p>
