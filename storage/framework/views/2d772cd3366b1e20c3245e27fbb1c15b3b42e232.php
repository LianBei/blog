...
<head>
  ...
  <script src="<?php echo e(asset('back/js/jquery-2.1.4.min.js')); ?>"></script>
<!--[if gte IE 9]>
  <script src="<?php echo e(asset('back/js/jquery-1.11.1.min.js')); ?>" type="text/javascript"></script>
...
<div class="container">
  <div class="siteIcon"><img src="<?php echo e(asset('storage/images/icon/icon.png')); ?>" alt="" data-toggle="tooltip" data-placement="top" title="欢迎使用异清轩博客管理系统" draggable="false" /></div>
